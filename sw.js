...
self.addEventListener('fetch', (e) => {
  ...
  if (url.hostname.includes('quotable.io') || url.hostname.includes('groq.com') || url.hostname.includes('jsonbin.io') || url.hostname.includes('googleapis.com')) {
